...
- Average temperature is approximately 22°C, indicating a stable growing environment.
- Humidity is concentrated around 86–89%, which is within the expected mushroom cultivation range.
- Mushroom yield shows relatively low variation, suggesting consistent production conditions.